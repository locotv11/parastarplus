!function() {
    ...
    function N(e) {
        ...
        if (a) {
            var i, o, d, l, t = window.jwplayer.defaults, n = V({}, t, a);
      ...
      , me = {
        events: {
            ...
            "ae-clienta": {
                ...
                bucket: "clienta",
                parameterGroups: ["global", "adGlobal", "headerBidding"],
                pingSpecificParameters: ["ad", "add", "adid", "adt", "adv", "advi", "aec", "aem", "amu", "apr", "apt", "ato", "atu", "caid", "cid", "ct", "did", "du", "ec", "fed", "idp", "iu", "mfc", "pei", "tal", "tpi", "uav"],
                pingDestination: "main"
            },
            "al-clienta": {
                code: "al",
                ...
                pingSpecificParameters: ["apr", "idp", "pei", "tal"],
            ...
            "ar-clienta": {
                ...
                bucket: "clienta",
                parameterGroups: ["global", "adGlobal"],
                pingSpecificParameters: ["apr", "apt", "fed", "idp", "ipv", "pei", "rtp", "tpi", "vsrid"],
                pingDestination: "main"
            },
            "avg-clienta": {
                code: "avg",
            ...
            "e-jwplayer6": {
                ...
                bucket: "jwplayer6",
                parameterGroups: ["global"],
                pingSpecificParameters: ["ab", "bpv", "cae", "cb", "cdid", "cme", "dd", "dnt", "dpl", "fed", "flc", "fv", "ga", "idp", "ipv", "lng", "mk", "mu", "opu", "pad", "pbc", "pd", "pdr", "pei", "plng", "plt", "pni", "po", "pogt", "ptid", "pvt", "rf", "sn", "sp", "srf", "st", "vrt"],
                filters: ["missingMediaOrExternalID"],
                pingDestination: "main"
            },
            "err-error": {
                ...
                bucket: "error",
                parameterGroups: ["global"],
                pingSpecificParameters: ["cme", "erc", "idp", "mu", "pei", "pogt", "strt"],
                pingDestination: "main"
            },
            "ers-error": {
                code: "ers",
                bucket: "error",
                parameterGroups: ["global"],
                pingSpecificParameters: ["cme", "erc", "flc", "idp", "pei", "pogt"],
                pingDestination: "main"
            },
            "fc-jwplayer6": {
                code: "fc",
            ...
            "i-clienta": {
                ...
                bucket: "clienta",
                parameterGroups: ["global", "adGlobal", "headerBidding"],
                pingSpecificParameters: ["ad", "adc", "add", "adid", "adv", "advi", "apr", "apt", "adt", "al", "amu", "atu", "caid", "cid", "ct", "did", "du", "fed", "fid", "fsm", "idp", "iu", "mfc", "pei", "psd", "strt", "tal", "vv", "uav"],
                pingDestination: "main"
            },
            "pa-jwplayer6": {
                code: "pa",
                bucket: "jwplayer6",
                parameterGroups: ["global"],
                pingSpecificParameters: ["ab", "abid", "abm", "apid", "bwe", "cme", "dnt", "dpl", "fed", "fid", "flc", "idp", "lng", "mu", "opu", "pd", "pdr", "pei", "plng", "pni", "pogt", "pr", "psd", "pvta", "sbr", "tb", "vd", "vh", "vw"],
                filters: ["missingMediaOrExternalID"],
                pingDestination: "main"
            },
            "paf-error": {
            ...
            "ret-jwplayer6": {
                ...
                bucket: "jwplayer6",
                parameterGroups: ["global"],
                pingSpecificParameters: ["abm", "ati", "avc", "bwe", "cst", "etw", "fed", "fid", "fls", "fsm", "idp", "mu", "pbs", "pdt", "pei", "pr", "q", "sbr", "srf", "ubc", "vh", "vr", "vti", "vw"],
                filters: ["missingMediaOrExternalID"],
                pingDestination: "main"
            },
            "s-jwplayer6": {
            ...
            "t-jwplayer6": {
                ...
                bucket: "jwplayer6",
                parameterGroups: ["global"],
                pingSpecificParameters: ["abm", "ati", "avc", "bwe", "cst", "dle", "fed", "fid", "fls", "fsm", "idp", "ltc", "mu", "pbs", "pcp", "pdt", "pei", "pw", "q", "sbr", "ti", "ubi", "vh", "vr", "vti", "vw"],
                filters: ["missingMediaOrExternalID"],
                pingDestination: "main"
            },
            "v-clienta": {
                ...
                bucket: "clienta",
                parameterGroups: ["global", "adGlobal"],
                pingSpecificParameters: ["ad", "adc", "adti", "adati", "advti", "al", "ct", "du", "fsm", "idp", "pei", "qt", "vv", "uav"],
                pingDestination: "main"
            },
            "vcae-clienta": {
                code: "vcae",
    ...
    function Ve(e, a, t) {
        ...
        e.meta.lastEvent = a,
        e.meta.lastBucket = t,
        e.playerData.visualQuality = G(n, "s" === a && "jwplayer6" === t),
    ...
    ;
    var na = V({}, _e, qe, Ne, ta, Ze, Ue, Oe, Ge, Le, Ke);
    function ra(e, i) {
        var a = me.events[e]
    ...
    var oa = function(e, a) {
      ...
      , fa = function(e, a, t, n) {
        ...
        return "main" === n && (i.host = la.main_fallback),
        i.url
    }
      , ma = function(e) {
        e.trackingState.pageLoaded = !0;
        for (var a = e.trackingState.queue.length; a--; )
            ya(e, e.trackingState.queue.shift());
    ...
    function va(e) {
        ...
        (e.trackingState.pageLoaded = t) || (e.trackingState.boundFlushQueue = ma.bind(null, e),
    ...
    function ka(e) {
        ...
        e.bidders.forEach(function(e) {
            ...
            U.forEach(function(e) {
                var a;
                "result" === e ? n.result = S[t[e]] : V(n, void 0 !== t[e] ? ((a = {})[e] = t[e],
                a) : void 0),
    ...
    function Da(t, e) {
        ...
        -1 === t.ads.adClient && e && (t.ads.adClient = O(e.client)),
    ...
    var Ea = {
        ...
        adTime: function(e, a) {
            ...
            i.visibleEvent.canSendPing(se) && r.totalVisibleSeconds >= Math.floor(t.duration / 2) && (ha(e, se, "clienta"),
            i.visibleEvent.setPingSent(se)),
            i.visibleEvent.canSendPing(ce) && 2 <= r.maxConsecutiveVisibleSeconds && (ha(e, ce, "clienta"),
    ...
    function Ca(i) {
        ...
        e.on("adClick adRequest adMeta adImpression adComplete adSkipped adError adTime adBidRequest adBidResponse adStarted adLoaded adViewableImpression adBreakEnd", function(e) {
            ...
            a = r,
            "adClick" === (t = e).type || a && a.adId === t.id && -1 !== t.id || (i.ads.adEventData = V({
                adId: e.id
            }, q),
            i.ads.pingLimiters.visibleEvent.resetAll(),
            i.ads.adPlaybackTracking = V({}, I)),
            n = e,
            -1 === C.indexOf(n.type) && Da(i, e),
            e.type in Ea ? Ea[e.type](i, e) : -1 === E.indexOf(e.type) && ha(i, P[e.type], "clienta")
        })
    }
    function Aa(e) {
        var a, t;
    ...
    function Oa(c, s) {
        return function(e) {
            ...
            n.segmentReceived = !1,
            La(c)) : c.meta.playbackSent || (c.meta.playbackSent = !0,
            La(c)))
        }
    }
    function Ga(e) {
    ...
    function Ha(v) {
        ...
        g.on("playlistItem", function(e) {
            var a = v.playlistItemData;
            a.drm = "",
            0 !== v.meta.playbackTracking.playSessionSequence && (a.itemId = L(12)),
        ...
        g.on("time", function(e) {
            ...
            if (n)
                if (v.meta.seekTracking.dragStartTime)
                    ...
                    p);
                    if (Na(v, t.playedSecondsTotal, f, 10),
                    Na(v, t.playedSecondsTotal, f, 30),
                    Na(v, t.playedSecondsTotal, f, 60),
                    t.playedSecondsTotal = t.playedSecondsTotal + f,
                    !0 === t.sendSetTimeEvents && (qa(v, n, 3),
                    qa(v, n, 10),
                    qa(v, n, 30)),
                    r <= 0 || r === 1 / 0)
        ...
        g.on("visualQuality", function(e) {
            ...
            k = a,
            t && -1 === r.indexOf(n.reason) && ha(v, "vqc")
        }),
        g.on(o.join(" "), function() {
            v.ads.adBreakTracking && (v.ads.adBreakTracking.shouldTrack = !0)
        }),
        g.on("error", Ua.bind(null, v, fe)),
        g.on("setupError", Ua.bind(null, v, pe)),
        ...
        g.on("captionsChanged", function(e) {
            0 !== e.track && 0 === v.playerData.captionsIndex && ha(v, ne),
        ...
        g.on("inference", function(e) {
            var t;
            t = e,
            v.inference.result = xa.reduce(function(e, a) {
                return t[a] && (e[a] = t[a]),
                e
            }, {})
        }),
        Wa(v),
        a = W,
        (e = v).meta.previousBufferTimes[a] = Xe(e)
    }
    function $a(e, a) {
            ...
            !function(a) {
                ...
                if (e.getPlugin) {
                    ...
                    t && t.on("click", function(e) {
                        a.sharing.shareMethod = Za[e.method] || Za.custom,
                        ha(a, $)
                    })
                }
            }(e)
    ...
    function st(e, a, t) {
        var n = a.sdkplatform ? parseInt(a.sdkplatform, 10) : M
          ...
          , c = void 0;
        if (l)
            ot && ot.removeItem("jwplayerLocalId");
        else {
            var s = function() {
                if (!ot)
                    return {
        ...
        }(), g = r.defaultPlaybackRate || 1, y = O(i.client);
        ...
        return {
            ...
            playerData: {
                ...
                playbackMode: null,
                stringifiedSetupConfig: N(e),
                captionsIndex: 0
            },
            staticPlayerData: (T = e,
            P = a,
            E = n,
            A = {
                playerVersion: (C = T.version,
                C.split("+")[0]),
                sdkPlatform: P.sdkplatform || M,
                embedID: L(12)
            },
            E && (A.sdkVersion = P.iossdkversion,
            A.bundleId = P.bundleId,
            A.advertisingId = P.advertisingId,
            A.deviceModel = P.deviceModel),
            A),
            casting: !1,
            ...
            I = {
                ...
                abTestConfig: k.pad,
                skinName: k.skin,
                advertisingBlockType: (D = k,
                D.advertising ? D.advertising.outstream ? 2 : 1 : 0),
            ...
            k.autostart in R && (I.autostartConfig = R[k.autostart]),
            S && (I.relatedPluginFeedFile = S.recommendations || S.file),
            I),
            ...
            meta: {
                ...
                !0 === b.doNotTrack || !0 === b.doNotTrackCookies),
                setupCount: ct,
                nthPlayer: o,
                playbackEvents: {},
                playbackSent: void 0,
    ...
    (window.jwplayerPluginJsonp || window.jwplayer().registerPlugin)("jwpsrv", "7.0", function(e, a, t) {
        ...
        et(o),
        va(u),
        this.getTrackingPixelURLs = (d = u,
        function(e, a) {
            d.ads.headerBiddingCacheData.bidder = e,
            d.ads.headerBiddingCacheData.cacheKey = a;
            ...
            return d.ads.headerBiddingCacheData.bidder = void 0,
            d.ads.headerBiddingCacheData.cacheKey = void 0,
            {
                impression: t,
                error: n
            }
        ...
        this.trackExternalAPIUsage = function(e, a) {
            var t, n, r;
            if (!(25 <= pt || .005 < Math.random()))
                return pt++,
                n = e,
                r = a,
                (t = u).playerData.apiTracking = {
                    methodCalled: n,
